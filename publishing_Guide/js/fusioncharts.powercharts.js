        ...
        dragExtension = {
            ...
            drawAxisUpdateUI: function() {
                ...
                each(['max', 'min'], function(value) {
                    ...
                    // better UX.
                    if (hasSVG) {
                        addEvent(chart.container, 'defaultprevented', defaultAction = function(e) {
                            if (inputElement.parentNode) {
                                lib.dem.fire(inputElement, 'blur', e);
                            }
                        });
                        // cleanup
                        addEvent(chart.container, 'destroy', function() {
            ...
            preSeriesAddition: function() {
                ...
                if (pluckNumber(chartAttr.allowaxischange, 1)) {
                    (hc.callbacks || (hc.callbacks = [])).push(function(chart) {
                        ...
                        addEvent(chart.renderer.container, 'destroy', function() {
                            if (interrupt) {
