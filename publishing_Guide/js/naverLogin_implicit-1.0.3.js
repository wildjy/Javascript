 ...
 */
	this.init_naver_id_login = function ()
	{
		...
		else if (this.button_type == 4) { // 로그인페이지
			naver_id_login_contents = "<a href='" + naver_id_login_url + "' " + naver_id_popup_option + " id='naver_id_login_anchor'><img src='https://imgorg.catch.co.kr/job/site/btn_login_naver.gif' border='0' alt='NAVER 로그인'></a> ";
		}
		else if (this.button_type == 5) { // 회원가입페이지
			naver_id_login_contents = "<a href='" + naver_id_login_url + "' " + naver_id_popup_option + " id='naver_id_login_anchor'><img src='https://imgorg.catch.co.kr/job/site/btn_join_naver.gif' border='0' alt=''> <span>네이버</span> 아이디로 회원가입</a> ";
		}
		else
		{
