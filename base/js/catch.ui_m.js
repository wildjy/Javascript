      ...
      totalNav : function(){
        ...
        openTotal.on("click", function(){
          if(tt_){
            ...
            totalNav.addClass("on").stop().animate({"height":"385px"}, 300);
            ...
            $('.dimm').on("click", function(){
              ...
              totalNav.stop().animate({"height":"0px"}, 50).removeClass("on");
              $(this).remove();
            })
          } else {
            tt_ = true;
    ...
    sub : {
      ...
      moveNav : function(nav, obj){
        if($(nav).length){
          ...
          _nav.each(function(){
            ...
            _mov = $(this).parent("div").index();

              $(".moving-nav").find("a").removeClass("active");
              $(this).addClass("active");

              midSlide.slideTo(_mov, 0, false);

              if($(".fix-nav").is(":visible")){
                console.log("fix")
                $("html, body").stop().animate({"scrollTop":_pos - 140}, 300, function(){
                  $(".thume>a").removeClass("active");
                  _rel.find(".thume>a").addClass("active");
                });
              } else {
                $("html, body").stop().animate({"scrollTop":_pos - 60}, 300);
              }
          ...
          _obj.each(function(index){
            ...
            $(window).scroll(function(){
              ...
              if(wPosY > offsetCods - 143){
                _nav.find(".swiper-slide").removeClass("active");
                _nav.find(".swiper-slide").eq(index).addClass("active");
      ...
      inside_sub : function(){
        ...
        _ttOpen.on("click", function(){
          if(_s){
            _s = false;
            _ttNavi.addClass("on").stop().animate({"right":"0%"}, 300);
            ...
            $('.close').on("click", function(){
              ...
              $(".biz-list>dt>a").parent().next("dd").stop().animate({"height":"0"}, 300);
              _ttNavi.removeClass("on").stop().animate({"right":"-100%"}, 150);
        ...
        $(".biz-list>dt>a").on("click", function(){
          if($(this).hasClass("open")){
            ...
            $(this).parent().next("dd").stop().animate({"height":"0"}, 300);
          } else {
            $(this).addClass("open");
            $(this).parent().next("dd").stop().animate({"height":"100%"}, 300);
          }
        })
        ...
        $(".year-close>a").on("click", function(){
          ...
          $("html, body").stop().animate({"scrollTop":_yTop}, 0);
          return false;
        });
        ...
        opF.on("click", function(){
          ...
          if(sta){
            ...
            for(var i = 0; i<=$a.length; i++){
              ...
              $a.eq(-i).css({"opacity":"1", "visibility":"visible"}).stop().animate({"top": -(($(this).width()) * i) + "px"}, 100 * i, function(){
                $a.addClass("on");
              });
            };
          } else {
            ...
            $a.find("span").remove();
            $a.css({"opacity":"0", "visibility":"hidden"}).stop().animate({"top":"0px"}, 100);
          }
          return false;
        });
